...
Hoy en día, las sustancias químicas abundan. Es por lo que, para llevar un mejor recuento de las sustancias ya existentes y las nuevas creadas, nos decidimos a hacer un sistema con dicho fin, en Haskell.
...
¹ Este ejercicio no refleja la realidad de las nomenclaturas químicas.
² Recuerden que existe la función show :: Show a => a -> String, que dado un valor nos devuelve su representación en un String. Es decir el string que usa para mostrar por pantalla.
